                ...
                <div className={styles.signup__form}>
                    ...
                    <>
                        ...
                        <TextField
                           ...
                           />
                           <View>
                                <Button variant="primary" onPress={() => setEditMode(true)} marginTop="size-100">Edit profile</Button> 
                           </View>
                    </>
                    :
                    <>
                        <Form maxWidth="size-4600" necessityIndicator="label" onSubmit={handleSubmit(onSubmit)}>
                        <div className={styles.signup__form__input}>
                            <div className={styles.signup__form__input__data}>
                                <label htmlFor='firstName'>First name:</label>
                                <input type='text' id="firstName" defaultValue={formData.firstName} className={styles.signup__form__input__data__input} {...register("firstName")}/>
                            </div>
                        ...
                        <div className={styles.signup__form__input}>
                            <div className={styles.signup__form__input__data}>
                                ...
                                <input type='text' id='lastName' defaultValue={formData.lastName} className={styles.signup__form__input__data__input} {...register("lastName")}/>
                            </div>
                        ...
                        <div className={styles.signup__form__input}>
                            <div className={styles.signup__form__input__data}>
                                ...
                                <input type='text' id='phone' defaultValue={formData.phone} className={styles.signup__form__input__data__input} {...register("phone")}/>
                            </div>
                        ...
                        <div className={styles.signup__form__input}>
                            <div className={styles.signup__form__input__data}>
                                ...
                                <input type='email' id='email' defaultValue={formData.email} className={styles.signup__form__input__data__input} {...register("email")}/>
                            </div>
                        ...
                        <Button variant='primary' type='submit' UNSAFE_className={styles.signup__form__submitbtn}>Save changes</Button>
                    </Form>
                    </>    
                }
                </div>
